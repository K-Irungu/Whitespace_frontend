        ...
        <ThemeProvider theme={theme}>
            ...
            <Grid container component="main"
                ...
                <Grid item
                    ...
                    sx={
                        {
                            backgroundImage: "url(https://images.unsplash.com/photo-1473864803180-ca1b3d93c9a0?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1169&q=80)",
                ...
                <Grid item
                    ...
                    <Box sx={
                        ...
                        <Box component="form" noValidate
                            ...
                            <TextField margin="normal" required fullWidth name="password" label="Password" type="password" id="password" autoComplete="current-password"/> {/* User type selection */}
                            <FormControl sx={
                                {
                                    mt: 2,
                                    ml: 1
                                ...
                                <RadioGroup aria-labelledby="demo-radio-buttons-group-label" name="radio-buttons-group"
                                    ...
                                    <FormControlLabel value="supervisor"
                                        control={<Radio/>}
                                        label="Supervisor"/>
                                    <FormControlLabel value="lecturer"
                                        control={<Radio/>}
                                        label="Lecturer"/>
